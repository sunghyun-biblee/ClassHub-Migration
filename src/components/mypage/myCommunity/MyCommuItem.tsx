...
import { selectCommuinfo } from "../../community/hooks/fetchCommuArray";
...
export const MyCommuItem = ({ item }: IcommuProp) => {
  ...
  return (
    <li
      className="border-[1px] shadow-[0px_1px_6px_rgba(149,157,165,0.3)] rounded-md"
      onClick={handleClick}
    >
      <ul className="grid md:grid-cols-[0.5fr,1fr,0.6fr,0.6fr,0.3fr] mysm:grid-cols-[1fr,1fr,1fr,0.7fr] text-center items-center">

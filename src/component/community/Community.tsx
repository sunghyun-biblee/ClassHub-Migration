...
export const Community = () => {
  ...
  lg:block  md:block mysm:block  "
      >
        <div className=" max-w-[100vw] lg:max-w-[1200px]  flex justify-start items-center py-3 lg:px-5 mx-auto my-0">
          <h1 className="text-white/90 font-bold text-2xl pt-1 md:pl-5">
            커뮤니티 페이지
